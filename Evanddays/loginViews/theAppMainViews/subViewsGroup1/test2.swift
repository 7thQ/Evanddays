...
//            LocateMeButton(viewport: $viewport)
        ...
        .onAppear {
            locationManager.requestLocationAuthorization()  // Direct method call
        }
...
//
//struct MapView: View {
//    @StateObject private var locationManager = LocationManager()  // Use @StateObject for lifecycle management
//
//    var body: some View {
//        Map {
//            UserAnnotation()
